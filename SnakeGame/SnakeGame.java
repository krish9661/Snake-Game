...
public class SnakeGame extends JPanel implements ActionListener, KeyListener{
    ...
    public void draw(Graphics g) {
        ...
        //snake head
        g.setColor(new Color(210,200,16));
    ...
    public void placeFood(){
        food.x = random.nextInt(boardWidth/tileSize); //600/24 =25
        food.y = random.nextInt(boardHeight/tileSize); //600/24 =25
    }
    ...
    public void keyPressed(KeyEvent e) {
        if(e.getKeyCode() == KeyEvent.VK_UP && velocityY!= 1){
            ...
            if(gamePause){
                ...
                System.out.println("Press Space-Bar to Resume");
            } else {
                gameLoop.restart();
